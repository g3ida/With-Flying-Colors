...
class PlayerAnimationSystem : IteratingSystem() {
    private val mPlayerAnimationComponent: ComponentMapper<PlayerAnimationComponent>? = null
    private val mTransformComponent: ComponentMapper<TransformComponent>? = null
